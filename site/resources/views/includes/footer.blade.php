<div class="pb-5 pt-5 pl-7 pr-7 bg-black flex justify-between items-center">
    ...
    @else
        <a href="/logout" class="relative inline-block text-lg group">
            <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-neutral-800 transition-colors duration-300 ease-out border-2 border-neutral-900 rounded-lg group-hover:text-white">
